/*
 * png2bmp/common.c : Twitter クライアント chirrup
 * $Log: /comm/chirrup/png2bmp/common.c $
 * 
...
#ifndef	lint
static char	*rcs_id =
"$Header: /comm/chirrup/png2bmp/common.c 1     09/05/14 3:50 tsupo $";
#endif
